...
public class LauncherAppTransitionManagerImpl extends LauncherAppTransitionManager
    ...
    public void playIconAnimators(AnimatorSet appOpenAnimator, View v, Rect windowTargetBounds, boolean windowToIcon) {
        ...
        if (useUpwardAnimation && !windowToIcon) {
            ...
            alpha.setStartDelay(windowToIcon ? 32 : (long) (APP_LAUNCH_DOWN_DUR_SCALE_FACTOR
                    * APP_LAUNCH_ALPHA_START_DELAY));
            alpha.setDuration(windowToIcon ? 50 : (long) (APP_LAUNCH_DOWN_DUR_SCALE_FACTOR * APP_LAUNCH_ALPHA_DURATION));
        }
        alpha.setInterpolator(LINEAR);
