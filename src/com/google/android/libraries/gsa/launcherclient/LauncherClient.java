...
public class LauncherClient {
    ...
    public final C1633a aey;
    public final BroadcastReceiver aez = new C1247d(this);
            ...
            switch (message.what) {
                case 2:
                    if ((this.client.aeD & 1) != 0) {
                        ...
                        if (floatValue <= 0.0f) {
                            this.client.aew.mo4036a(0, "onScroll 0, overlay closed", 0.0f);
                        } else if (floatValue >= 1.0f) {
                            this.client.aew.mo4036a(0, "onScroll 1, overlay opened", 0.0f);
                        } else {
                            this.client.aew.mo4036a(1, "onScroll", floatValue);
                        }
                    }
                    return true;
                case 3:
    ...
    public LauncherClient(Activity activity, LauncherClientCallbacks c1250g, ClientOptions c1249f) {
        ...
        this.aeE = c1249f.options;
        this.aey = C1633a.m5340I((Context) activity);
        C1633a c1633a = this.aey;
        c1633a.aem = new WeakReference(this);
        this.aeA = c1633a.ael;
    ...
    public final void onAttachedToWindow() {
        if (!this.aeC) {
            this.aev.mo4036a(0, "attachedToWindow", 0.0f);
            mo4016a(this.aet.getWindow().getAttributes());
        }
    }
    ...
    /* renamed from: a */
    public final void mo4016a(LayoutParams layoutParams) {
    ...
    /* renamed from: ii */
    public final void mo4022ii() {
        this.aev.mo4036a(0, "startMove", 0.0f);
        if (isConnected()) {
            try {
    ...
    /* renamed from: ij */
    public final void mo4023ij() {
        this.aev.mo4036a(0, "endMove", 0.0f);
        if (isConnected()) {
            try {
                this.aeA.endScroll();
            } catch (RemoteException e) {
    ...
    /* renamed from: i */
    public final void mo4019i(float f) {
        this.aev.mo4036a(1, "updateMove", f);
        if (isConnected()) {
            try {
                this.aeA.onScroll(f);
            } catch (RemoteException e) {
    ...
    /* renamed from: J */
    public final void mo4014J(boolean z) {
    ...
    /* renamed from: bl */
    public final void mo4018bl(int i) {
        if (i <= 0 || i > 2047) {
            throw new IllegalArgumentException("Invalid duration");
        }
        int i2 = 1 | (i << 2);
        this.aev.parse("hideOverlay", i);
        if (this.aeA != null) {
            try {
    ...
    /* renamed from: K */
    public final void mo4015K(boolean z) {
        this.aev.mo4037c("showOverlay", z);
        if (this.aeA != null) {
            try {
                this.aeA.openOverlay(z);
            } catch (RemoteException e) {
            }
        }
    }
    ...
    public final boolean startSearch(byte[] bArr, Bundle bundle) {
        this.aev.mo4036a(0, "startSearch", 0.0f);
    ...
    public final void mo4020i(Bundle bundle) {
        ...
        c1245b.mo4036a(0, valueOf.length() != 0 ? str.concat(valueOf) : new String(str), 0.0f);
        this.aeH = bundle;
        mo4024ik();
    }
    ...
    /* renamed from: K */
    private static void m3606K(Context context) {
