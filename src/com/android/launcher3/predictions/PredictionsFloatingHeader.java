...
public class PredictionsFloatingHeader extends FloatingHeaderView implements Insettable {
    ...
    public PredictionsFloatingHeader(Context context, AttributeSet attributeSet) {
        ...
        this.f1928yi = context.getResources().getDimensionPixelSize(R.dimen.all_apps_header_top_padding);
    }

    protected void onFinishInflate() {
        super.onFinishInflate();
        this.f1929yj = (PredictionRowView) findViewById(R.id.prediction_row);
        this.f1930yk = (ActionsRowView) findViewById(R.id.actions_row);
    }
