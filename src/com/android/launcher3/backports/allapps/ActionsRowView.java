...
public class ActionsRowView extends LinearLayout implements LogContainerProvider, C0836l {
    ...
    public ActionsRowView(Context context, AttributeSet attributeSet) {
        ...
        this.f2422Bv = context.getResources().getDimensionPixelSize(R.dimen.all_apps_action_spacing);
        this.f2424Bx = new C1811m(this, this.mLauncher);
        LauncherAccessibilityDelegate launcherAccessibilityDelegate = this.f2424Bx;
        launcherAccessibilityDelegate.mActions.put(R.id.action_dismiss_suggestion, new AccessibilityAction(
		        R.id.action_dismiss_suggestion, launcherAccessibilityDelegate.mLauncher.getText(R.string.dismiss_drop_target_label)));
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        i -= paddingRight;
        super.onMeasure(MeasureSpec.makeMeasureSpec(((i - ((i / deviceProfile.inv.numHotseatIcons) - Math.round(0.92f * ((float) deviceProfile.iconSizePx)))) + getPaddingLeft()) + getPaddingRight(), MeasureSpec.EXACTLY), i2);
    }
    ...
    public final void mo3431e(ArrayList arrayList) {
        ...
        for (i = 0; i < getChildCount(); i++) {
            ...
            if (min > i) {
                ...
                shortcutInfo.contentDescription = getContext().getString(R.string.suggested_action_content_description, new Object[]{c0828a.contentDescription, c0828a.f1198AJ});
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.f2420Bt) {
            ...
            int height = (getHeight() - getResources().getDimensionPixelSize(R.dimen.all_apps_label_bottom_padding)) - this.f2421Bu.getHeight();
