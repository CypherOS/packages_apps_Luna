...
import com.android.launcher3.predicitons.PredicitonsHeaderListener;
...
public class PredictionsFloatingHeader extends FloatingHeaderView implements Insettable, PredicitonsHeaderListener {
    ...
    public PredictionsFloatingHeader(Context context, AttributeSet attributeSet) {
        ...
        this.f2453Ca = context.getResources().getDimensionPixelSize(2131165198);
        this.f2450BZ = PredictionUiStateManager.m2238a(context);
    }

    protected void onFinishInflate() {
        super.onFinishInflate();
        this.f2454Cb = (PredictionRowView) findViewById(2131361917);
        this.f2455Cc = (ActionsRowView) findViewById(2131361811);
    }
    ...
    private void m2265dj() {
        ...
        if (actionsRowView.f2420Bt != z) {
            ...
            if (actionsRowView.f2420Bt) {
                ...
                textPaint.setColor(ContextCompat.getColor(actionsRowView.getContext(), Themes.getAttrBoolean(actionsRowView.getContext(), 2130968625) ? 2131099651 : 2131099650));
                textPaint.setTextSize((float) actionsRowView.getResources().getDimensionPixelSize(2131165200));
                text = actionsRowView.getResources().getText(2131820575);
            ...
            actionsRowView.setPadding(actionsRowView.getPaddingLeft(), actionsRowView.getPaddingTop(), actionsRowView.getPaddingRight(), actionsRowView.f2420Bt ? (actionsRowView.f2421Bu.getHeight() + actionsRowView.getResources().getDimensionPixelSize(2131165201)) + actionsRowView.getResources().getDimensionPixelSize(2131165199) : 0);
        }
        ...
        if (predictionRowView.f2440BO != dividerType) {
            if (dividerType == DividerType.ALL_APPS_LABEL) {
                ...
                predictionRowView.f2435BJ.setTextSize((float) predictionRowView.getResources().getDimensionPixelSize(2131165200));
                text = predictionRowView.getResources().getText(2131820575);
    ...
    public final int getMaxTranslation() {
        if (this.mMaxTranslation == 0 && this.mTabsHidden) {
            return getResources().getDimensionPixelSize(2131165206);
        }
        if (this.mMaxTranslation <= 0 || !this.mTabsHidden) {
