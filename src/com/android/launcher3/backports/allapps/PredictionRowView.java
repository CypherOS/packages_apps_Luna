...
public class PredictionRowView extends LinearLayout implements OnDeviceProfileChangeListener, OnUpdateListener, LogContainerProvider {
    ...
    public PredictionRowView(Context context, AttributeSet attributeSet) {
        ...
        if (attrBoolean) {
            i = R.color.all_apps_prediction_row_separator_dark;
        } else {
            i = R.color.all_apps_prediction_row_separator;
        }
        ...
        this.f2432BG = Themes.getAttrColor(context, R.attr.darkTintColor);
        this.f2433BH = Color.alpha(this.f2432BG);
        this.f2434BI = this.f2433BH;
        this.f2435BJ.setColor(ContextCompat.getColor(context, attrBoolean ? R.color.all_apps_label_text_dark : R.color.all_apps_label_text));
    ...
    private void m2257dh() {
        ...
        if (size == 0) {
            if (this.f2445BT == null) {
                this.f2445BT = LayoutInflater.from(getContext()).inflate(R.layout.prediction_load_progress, this, false);
            }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.f2440BO == DividerType.LINE) {
            dimensionPixelSize = getResources().getDimensionPixelSize(R.dimen.dynamic_grid_edge_margin);
        ...
        if (this.f2440BO == DividerType.ALL_APPS_LABEL) {
            ...
            int height2 = (getHeight() - getResources().getDimensionPixelSize(R.dimen.all_apps_label_bottom_padding)) - this.f2448Bu.getHeight();
    ...
    void mo5375di() {
        ...
        setAlpha(this.f2443BR.value * (interpolation + ((1.0f - interpolation) * ((float) (f2441BP ? 1.0f : 0.0f)))));
    }
}
