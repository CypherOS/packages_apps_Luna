...
public class PredictionRowView extends LinearLayout implements OnDeviceProfileChangeListener, OnUpdateListener, LogContainerProvider {
    ...
    /* renamed from: BB */
    private static final Interpolator f2427BB = -$$Lambda$PredictionRowView$jubm2-lCMZXbTP8MtkTgNvZml1o.INSTANCE;
    /* renamed from: BC */
    ...
    public PredictionRowView(Context context, AttributeSet attributeSet) {
        ...
        this.f2442BQ = 0.0f;
        this.f2443BR = new AnimatedFloat(new -$$Lambda$g0GGOL4NhPGXvFsgJ2NegTVDbP4(this));
        this.f2444BS = new AnimatedFloat(new -$$Lambda$g0GGOL4NhPGXvFsgJ2NegTVDbP4(this));
        this.f2449Bw = false;
        this.f2446BU = false;
        setOrientation(0);
    ...
    private void m2257dh() {
        ...
        int f = C0199a.m164f(this.f2432BG, this.f2434BI);
    ...
    public final void setValue(int i) {
        ...
        i = C0199a.m164f(this.f2439BN, Math.round(((float) (Color.alpha(this.f2439BN) * i)) / 255.0f));
        if (i != this.mPaint.getColor()) {
            this.mPaint.setColor(i);
            this.f2438BM = Math.round((float) ((this.f2437BL * this.f2434BI) / this.f2433BH));
            this.f2435BJ.setColor(C0199a.m164f(this.f2436BK, this.f2438BM));
    ...
    void mo5375di() {
        ...
        setAlpha(this.f2443BR.value * (interpolation + ((1.0f - interpolation) * ((float) (this.f2441BP ^ 1)))));
    }
}
