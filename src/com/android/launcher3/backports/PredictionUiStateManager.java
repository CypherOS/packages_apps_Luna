...
public class PredictionUiStateManager implements OnSharedPreferenceChangeListener, OnGlobalLayoutListener, ItemInfoUpdateReceiver {
    ...
    private PredictionUiStateManager(Context context) {
        ...
        this.f2411Am.f1266DA = new -$$Lambda$aHKETHwa15VFsgH6Y5igSFq1SGY(this);
        this.f2412An.f1186AC = new -$$Lambda$aHKETHwa15VFsgH6Y5igSFq1SGY(this);
    }
    ...
    private void m2239a(C0858i c0858i) {
        ...
        this.f2416Ar = c0858i;
        if (this.mAppsView != null) {
            ((C0857h) this.mAppsView.mHeader).mo3477a(this.f2416Ar.f1286Av, this.f2416Ar.f1287Aw);
    ...
    private C0858i m2242cU() {
        ...
        if (c0858i.f1286Av) {
            ...
            Object string = this.f2410Al.getString(this.f2414Ap.mKeyConfg.f1325Gq, null);
            int i = 0;
