...
public class QuickEvents {
	...
	private static final int AMBIENT_INFO_MAX_DURATION = 60000; // 1 minute
...
// Event identifiers end
	...
	public void ambientPlayEvent() {
		...
		mEventTitleText = Integer.parseInt(String.format(mContext.getResources().getString(
				R.string.quick_event_ambient_information), entry.getSongTitle(), entry.getArtistTitle()));
