...
public class QuickEvents {
    ...
    public QuickEvents(Context context) {
		mContext = context;
		mQuickSpace = new QuickSpaceView(context);
		initQuickEvents();
    }
	...
	private void deviceIntroEvent() {
		...
		mIsQuickEvent = true;
		mQuickSpace.setEventTitle(R.string.quick_event_device_intro_welcome);
		mQuickSpace.setEventSubTitle(R.string.quick_event_device_intro_learn);
	}
