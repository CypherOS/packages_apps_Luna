...
public class QuickSpaceView extends FrameLayout implements ValueAnimator.AnimatorUpdateListener, WeatherClient.WeatherObserver, Runnable {
	...
	public QuickSpaceView(Context context) { }
	...
	private void loadDoubleLine() {
        ...
        mEventSubIcon.setImageResource(mEventSubIconResource != null ? mEventSubIconResource : R.drawable.ic_info_no_shadow);
	...
	public void setEventTitle(int title) {
		mEventTitleText = title;
	}

	public void setEventSubTitle(int titleSub) {
		mEventTitleSubText = titleSub;
	}

	public void setEventSubIcon(int iconSub) {
