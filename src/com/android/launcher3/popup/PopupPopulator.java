...
public class PopupPopulator {
    ...
    static final class C04892 implements Runnable {
        ...
        C04892(NotificationItemView notificationItemView, Launcher launcher, List list, Handler handler, ComponentName componentName, List list2, UserHandleCompat userHandle, List list3, PopupContainerWithArrow popupContainerWithArrow, List list4, List list5, ItemInfo itemInfo) {
