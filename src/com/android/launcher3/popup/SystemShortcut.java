        ...
        public OnClickListener getOnClickListener(final Launcher launcher, final ItemInfo itemInfo) {
            return new OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    com.android.launcher3.AppInfo appInfo = new com.android.launcher3.AppInfo(launcher, laic, itemInfo.user, launcher.getIconCache());
                    new Launcher.startEdit(bm, itemInfo, launcher).show();
                }
            };
        }
    }
