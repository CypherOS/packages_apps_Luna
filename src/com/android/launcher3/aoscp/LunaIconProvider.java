...
public class LunaIconProvider implements Runnable{
	
	private static final boolean DBG = false;
    private static final String TAG = "LunaIconProvider";
    ...
    public Drawable getIcon(LauncherActivityInfo launcherActivityInfo, int iconDpi, boolean flattenDrawable) {
        ...
        if (drawable == null) {
            drawable = getIcon(launcherActivityInfo, iconDpi, flattenDrawable);
