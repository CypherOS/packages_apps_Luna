...
public class LauncherDragIndicator extends ImageView implements OnClickListener, Insettable {
    ...
    public void setInsets(Rect rect) {
        ...
        if (dp.isVerticalBarLayout()) {
            if (dp.isSeascape()) {
                layoutParams.leftMargin = dp.hotseatBarSidePaddingPx;
                layoutParams.rightMargin = rect.right;
                layoutParams.gravity = 85;
            } else {
                layoutParams.leftMargin = rect.left;
                layoutParams.rightMargin = dp.hotseatBarSidePaddingPx;
    ...
    public void onClick(View view) {
        if (!mLauncher.isInState(LauncherState.ALL_APPS)) {
            ...
            mLauncher.mStateManager.goToState(LauncherState.ALL_APPS);
        }
    }
}
