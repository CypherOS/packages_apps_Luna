...
public abstract class AbstractQsbLayout extends FrameLayout implements LauncherLayoutChangeListener, OnClickListener, OnSharedPreferenceChangeListener {
    ...
    private static AbstractQsbLayout sAbstractQsbLayout;
	...
	public static AbstractQsbLayout getInstance() {
        synchronized (LOCK) {
            if (sAbstractQsbLayout == null) {
                sAbstractQsbLayout = new AbstractQsbLayout(mContext);
            }
        }
        return sAbstractQsbLayout;
    }
