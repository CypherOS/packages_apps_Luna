...
public class PredicitonsUserEventDispatcher extends UserEventDispatcher implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public PredicitonsUserEventDispatcher(Context context) {
        mContext = context;
