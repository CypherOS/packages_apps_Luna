...
public class LauncherIcons {
    ...
    public static Bitmap createBadgedIconBitmap(Drawable drawable, UserHandleCompat userHandle, Context context, int i) {
        float f = 1.0f;
    ...
    public static Bitmap badgeIconForUser(Bitmap bitmap, UserHandleCompat userHandle, Context context) {
		UserHandle userHandle2 = Utilities.myUserHandle();
        if (userHandle == null || UserHandleCompat.myUserHandle().equals(userHandle)) {
            return bitmap;
        }
        Drawable userBadgedIcon = context.getPackageManager().getUserBadgedIcon(new FixedSizeBitmapDrawable(bitmap), userHandle2);
    ...
    public static Bitmap createShortcutIcon(ShortcutInfoCompat shortcutInfoCompat, Context context, boolean z) {
        ...
        if (shortcutIconDrawable == null) {
            defaultIcon = iconCache.getDefaultIcon(UserHandleCompat.myUserHandle());
        } else {
        ...
        if (activity != null) {
            ...
            appInfo.user = UserHandleCompat.myUserHandle();
