...
public class PredictionRowView extends LinearLayout implements LogContainerProvider, OnUpdateListener, OnDeviceProfileChangeListener,
    ...
    public static final Interpolator<PredictionRowView> ALPHA_FACTOR_INTERPOLATOR = new Interpolator<PredictionRowView>("alphaInterpolator") {
		public final float getInterpolation(PredictionRowView predictionRowView, float alpha) {
			return predictionRowView.getInterpolation(alpha);
		}
	}
    ...
    public static float getInterpolation(float alpha) {
        if (alpha < 0.8f) {
            return 0.0f;
        }
    ...
    public void setup(PredictionsFloatingHeader predictionsFloatingHeader, boolean tabsHidden) {
        mParent = predictionsFloatingHeader;
        setPredictionsEnabled(tabsHidden);
    }

    public void setPredictionsEnabled(boolean tabsHidden) {
        if (tabsHidden != mPredictionsEnabled) {
            mPredictionsEnabled = tabsHidden;
            updateVisibility();
        }
    }
    ...
    public void setPredictedApps(List<ComponentKeyMapper> list) {
        setPredictionsEnabled(mPredictionsEnabled);
