...
/* renamed from: com.android.launcher3.reflection.research.a.a */
public class C0938a<T> {
    /* renamed from: dj */
    public int f273dj = -1;
    /* renamed from: dk */
    public int f274dk = 0;
    ...
    /* renamed from: R */
    public final boolean mo9168R() {
        return this.f276dm != null && this.f276dm.size() < this.f275dl.length;
    }

    /* renamed from: a */
    public final T mo9170a(T t) {
        this.f273dj++;
        if (this.f273dj == this.f275dl.length) {
            this.f273dj = 0;
        }
        if (this.f275dl[this.f273dj] != null && mo9168R()) {
