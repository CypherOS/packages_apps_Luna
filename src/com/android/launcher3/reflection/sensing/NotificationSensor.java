...
public class NotificationSensor implements StatusBarNotificationsChangedListener, C0835a, C0947a {
    ...
    public void onNotificationPosted(StatusBarNotification statusBarNotification) {
        ReflectionClient.getInstance(this.mContext).postNotificationEvent(new C0842-$$Lambda$NotificationSensor$JV4C1Qy8cFKwxu4HvDhifAUXgn4(this, statusBarNotification));
    }
    ...
    public void onNotificationRemoved(StatusBarNotification statusBarNotification) {
        ReflectionClient.getInstance(this.mContext).postNotificationEvent(new C0841-$$Lambda$NotificationSensor$DJfaQHaP0-43iDKaKbOBJVymlqM(this, statusBarNotification));
    }
