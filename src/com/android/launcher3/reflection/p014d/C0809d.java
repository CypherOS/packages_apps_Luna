...
/* renamed from: com.google.android.apps.nexuslauncher.reflection.d.d */
public class C0809d {
    /* renamed from: bO */
    ...
    void log(List<C0813b> list) {
        ...
        ? r0v0 = 0;
        try {
            ? dataOutputStream = new DataOutputStream(new BufferedOutputStream(new FileOutputStream(this.f149bO, true)));
            try {
