...
public class ShortcutsRowView extends LinearLayout implements UpdateListener, LogContainerProvider {
    ...
    public void onAttachedToWindow() {
        ...
        onShortcutsUpdated(mShortcutsController.getPredictionShortcuts());
    }
    ...
    public void onShortcutsUpdated(ArrayList<Shortcut> predictions) {
        ...
        for (i = 0; i < getChildCount(); i++) {
            ...
            if (size > i) {
                ...
                shortcutInfo.contentDescription = getContext().getString(R.string.suggested_action_content_description, new Object[]{shortcut.contentDescription, shortcut.openingPackageDescription});
                view.applyFromShortcutInfo(shortcutInfo);
                view.setAction(shortcut, i);
