...
public class ShortcutsRowView extends LinearLayout implements UpdateListener, LogContainerProvider {
	...
	private ArrayList<Shortcut> mPredictedShortcuts;
    ...
    public void onAttachedToWindow() {
        ...
        onShortcutsUpdated(getPredictedShortcuts());
    }
	...
	private ArrayList<Shortcut> getPredictedShortcuts() {
		return mPredictedShortcuts;
	}

	@Override
    public void onShortcutsUpdated(ArrayList<Shortcut> predictions) {
		mPredictedShortcuts = predictions;
		Log.d(TAG, "Updating shortcut predictions view");
        int i;
        mPredictionsMinSize = Math.min(2, mPredictedShortcuts.size());
        ...
        for (i = 0; i < getChildCount(); i++) {
            ...
            if (mPredictionsMinSize > i) {
                ...
                Shortcut shortcut = (Shortcut) mPredictedShortcuts.get(i);
