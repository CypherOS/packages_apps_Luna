...
public class PredictionRowView extends LinearLayout implements LogContainerProvider, OnDeviceProfileChangeListener {
    ...
    public void setup(PredictionsFloatingHeader predictionsHeader, boolean isPredictions, AllAppsStore allAppsStore) {
    ...
    public void updatePredictedApps() {
        if (mPredictedApps != null && mApps != null) {
    ...
    public List<ItemInfoWithIcon> processPredictedAppComponents(List<ComponentKeyMapper> list) {
        ...
        for (ComponentKeyMapper app : list) {
            ItemInfoWithIcon app2 = app.getApp(mApps);
            if (app2 != null) {
