...
public class ShortcutView extends BubbleTextView implements OnLongClickListener {
    ...
    public class MyDragPreviewProvider extends DragPreviewProvider {
        ...
        public MyDragPreviewProvider(ShortcutView view, Point point) {
        ...
        public float getScaleAndPosition(Bitmap bitmap, int[] iArr) {
            ...
            float iconSize = ((float) mShortcutView.getIconSize()) / ((float) launcher.getDeviceProfile().iconSizePx);
        ...
        public Bitmap createDragBitmap() {
            Rect drawableBounds = DragPreviewProvider.getDrawableBounds(mShortcutView.getIcon());
    ...
    public ShortcutView(Context context, AttributeSet attributeSet) {
        ...
        setTextSize(0, Launcher.getLauncher(context).getDeviceProfile().allAppsIconTextSizePx);
    }

    public void setAction(Shortcut action, int position) {
        mShortcut = action;
        mPos = position;
    }

    public Shortcut getAction() {
        return mShortcut;
    }
    ...
    public boolean onLongClick(View view) {
        ...
        point.x = point2.x;
        point.y = point2.y;
        DragView dragView = launcher.getWorkspace().beginDragShared(view, launcher.getAppsView(), itemInfo, new MyDragPreviewProvider(this, point), dragOptions);
        Rect rect = new Rect();
        getIconBounds(rect);
