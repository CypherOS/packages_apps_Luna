...
public class ActionsRowView extends LinearLayout implements UpdateListener, LogContainerProvider {
    ...
    public ActionsRowView(Context context, AttributeSet attributeSet) {
		...
		mActionAccessibilityDelegate.mActions.put(R.id.action_dismiss_suggestion, new AccessibilityAction(
		        R.id.action_dismiss_suggestion, mActionAccessibilityDelegate.mLauncher.getText(R.string.dismiss_drop_target_label)));
    }
