...
public class ActionsController implements OnSharedPreferenceChangeListener, Callback {
    ...
    private ArrayList<Action> loadPredictedActions() {
        ...
        try {
            ...
            try {
                client = mContext.getContentResolver().acquireUnstableContentProviderClient(SUGGEST_PROVIDER);
                try {
                    Cursor query = client.query(SUGGEST_PROVIDER, ACTION_DATA, null, null, null);
                    if (query == null) {
                        try {
                    ...
                    while (true) {
                        ...
                        if (actionData.expTimeMils <= 0 || actionData.expTimeMils >= System.currentTimeMillis()) {
                            ...
                            Log.d("ActionsController", stringBuilder.toString());
                        }
                    }
                    DeepShortcutManager dsm = DeepShortcutManager.getInstance(mContext);
                    ...
                    while (hashMapIterator.hasNext()) {
                        ...
                        for (ShortcutInfoCompat shortcutInfoCompat : dsm.queryForFullDetails(keyData, actionDataList, Process.myUserHandle())) {
                            ...
                            if (dataParse != null) {
                                if (TextUtils.isEmpty(shortcutInfoCompat.getShortLabel())) {
                                    ...
                                    Log.e("ActionsController", emptyShortcutInfo.toString());
                                }
                                ItemInfoWithIcon shortcutInfo = new ShortcutInfo(shortcutInfoCompat, mContext);
                                ...
                                try {
                                    Action action = new Action(dataParse.actionId, dataParse.shortcutId, 
									        dataParse.expTimeMils, dataParse.publisherPkg, dataParse.badgePackage, 
                            ...
                            Log.w("ActionsController", shortCutDetailsEmpty.toString());
                        }
                    }
                    try {
            ...
            Log.e("ActionsController", "error loading actions", e);
        }
    }
