...
public class ActionView extends BubbleTextView implements OnLongClickListener {
    ...
    public class MyDragPreviewProvider extends DragPreviewProvider {
        ...
        public MyDragPreviewProvider(ActionView view, Point point) {
        ...
        public float getScaleAndPosition(Bitmap bitmap, int[] iArr) {
            ...
            float iconSize = ((float) mActionView.getIconSize()) / ((float) launcher.getDeviceProfile().iconSizePx);
        ...
        public Bitmap createDragBitmap() {
            Rect drawableBounds = DragPreviewProvider.getDrawableBounds(mActionView.getIcon());
