...
public class AppSearchProvider extends ContentProvider {
    ...
    public AppFilter getBaseFilter() {
        if (mBaseFilter == null) {
            mBaseFilter = new AppFilter(getContext());
        }
        return mBaseFilter;
    }
	...
	class SearchTask implements Callable<List<AppInfo>>, ModelUpdateTask {
        ...
        public List<AppInfo> call() {
            ...
            if (mModel.isModelLoaded()) {
                ...
                List<AppInfo> data = DefaultAppSearchAlgorithm.getApps(mApp.getContext(), mAllAppsList.data, AppSearchProvider.getBaseFilter());
