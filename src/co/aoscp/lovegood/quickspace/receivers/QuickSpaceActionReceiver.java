...
public class QuickSpaceActionReceiver {
	...
	private void openGoogleCalendar(View view) {
        ...
        try {
            ...
            LauncherAppsCompat.getInstance(getContext()).showAppDetailsForProfile(new ComponentName(LunaLauncherCallbacks.SEARCH_PACKAGE, ""), Process.myUserHandle());
		}
    }
	...
	private void openGoogleWeather(View view) {
		...
		try {
            ...
            LauncherAppsCompat.getInstance(getContext()).showAppDetailsForProfile(new ComponentName(LunaLauncherCallbacks.SEARCH_PACKAGE, 
