...
public class QuickSpaceView extends FrameLayout implements AnimatorUpdateListener, IQuickspace, IEventInfo {
	...
	private Drawable getEventIcon() {
		Drawable eventIcon = getContext().getResources().getDrawable(R.drawable.ic_quick_event_default);
		if (mEventType == QuickspaceEventController.EVENT_AMBIENT_PLAY) {
			eventIcon = getContext().getResources().getDrawable(R.drawable.ic_quick_event_ambient);
		}
		return eventIcon;
	}
