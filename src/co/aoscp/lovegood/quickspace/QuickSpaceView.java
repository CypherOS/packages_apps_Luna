...
import co.aoscp.lovegood.QuickspaceController.OnWeatherDataListener;
import co.aoscp.lovegood.QuickspaceController.OnQuickEventListener;
import co.aoscp.lovegood.views.DateTextView;

public class QuickSpaceView extends FrameLayout implements AnimatorUpdateListener, Runnable, 
        OnWeatherDataListener, OnQuickEventListener {
    ...
    public final void loadDoubleLine() {
        ...
        mEventTitle.setEllipsize(TextUtils.TruncateAt.END);
