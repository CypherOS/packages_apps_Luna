        ...
        if (cryptoObject != null) {
            final FingerprintManager.AuthenticationCallback authCallback = new FingerprintManager.AuthenticationCallback() {
                ...
                public void onAuthenticationHelp(int helpMsgId, CharSequence helpString) {
                    updateStatus(R.string.app_lock_authentication_status_retry, STATE_FINGERPRINT_ERROR);
                    mCallback.onAuthenticationHelp(helpMsgId, helpString);
                }

                @Override
                public void onAuthenticationFailed() {
                    updateStatus(R.string.app_lock_authentication_status_unrecognized, STATE_FINGERPRINT_ERROR);
